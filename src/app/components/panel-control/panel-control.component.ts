...
export class PanelControlComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.registerService.obtenerTodos('sorteos').subscribe(sorteosRef => {
  ...
  asignarRegalo() {
    ...
    this.registerService.createWithCustomId('sorteos', 'ultimoSorteo', { listaSorteada });
  }
  ...
  eliminarSorteo() {
    ...
    this.registerService.eliminar('sorteos', 'ultimoSorteo');
